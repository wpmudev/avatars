...
<?php if( !get_option( 'users_can_register' ) ) _e( ' (Signup has been disabled. Only members of this site can comment)' ); ?>
</label>
<br />
...
if (get_option('avatar_default') == '') {
	...
	<label><input name="avatar_default" id="avatar_mystery" value="local_default" <?php if ( get_option('avatar_default') == 'local_default' ) { echo 'checked="checked"';  } ?><?php if ( !get_option('avatar_default') ) { echo 'checked="checked"';  } ?> type="radio"> <img alt="" src="http://www.gravatar.com/avatar/ad516503a11cd5ca435acc9bb6523536?s=32&amp;d=<?php echo urlencode($local_default_avatar_url . '32.png'); ?>&amp;r=G&amp;forcedefault=1" class="avatar avatar-32" height="32" width="32"> Default</label><br>
